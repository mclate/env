...
"  <F2>  Add a mark on the current line (and highlight)
"  <F3>  Remove the mark on the current line
"  <F7>  Erase all markers [a-z]
"  <F8>  Turn off the highlighting for marked lines
"
...
hi Marks term=reverse ctermfg=0 ctermbg=4 guibg=Grey60
...
nmap <silent> <F2> :call AddHLMark("Marks")<CR>
nmap <silent> <F3> :call DelHLMark("Marks")<CR>
nmap <silent> <F7> :call clearmatches()\|:delmarks a-z<CR>
nmap <silent> <F8> :call clearmatches()<CR>
